...
fetchPackageCategories() {
  discounted.clear();
  normal.clear();
  for (var data in userInfo.read("allPackages")) {
    if (data["discount"] > 0) {
      discounted.add(data);
    } else {
      normal.add(data);
...
fetchAccountCategories() {
  users.clear();
  dispatchers.clear();
  for (var data in userInfo.read("allAccounts")) {
...
fetchOrderCategories() {
  paidOrders.clear();
  podOrders.clear();
  for (var data in userInfo.read("allOrders")) {
...
fetchLocationCategories() {
  ...
  for (var data in userInfo.read("allLocations")) {
...
fetchRefundCategories() {
  ...
  for (var data in userInfo.read("allRefunds")) {
...
fetchDataLogCategories() {
  adminLogs.clear();
  userLogs.clear();
  for (var data in userInfo.read("allDataLogs")) {
