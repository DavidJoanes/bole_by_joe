...
//   late var temp2 = ValueNotifier(userInfo.read("province"));
...
//     if (userInfo.read("myLocations").isNotEmpty) {
//       for (var element in nameOfLocations) {
//         for (var element2 in userInfo.read("myLocations")) {
...
//   void initState() {
//     setState(() {
//       userInfo.writeIfNull("myLocations", []);
//       userInfo.read("myLocations").clear();
...
//               itemCount: userInfo.read("myLocations").length,
...
//                       child: ListTile(
//                         title: Text(
//                             (userInfo.read("myLocations")[index]['nameoflocation']
//                                     as String)
//                                 .toUpperCase(),
//                             style: fontStyle1),
//                         subtitle: Text(
//                             "${userInfo.read("myLocations")[index]['address']}",
//                             style: fontStyle1b),
//                         trailing: Text(
//                             "${userInfo.read("myLocations")[index]['city']}",
//                             style: fontStyle1b),
//                       ),
//                     ),
//                   ),
...
//     final nameOfLoc = userInfo.read("myLocations")[index]["nameoflocation"];
//     showDialog(
//         barrierDismissible: false,
//         context: context,
//         builder: (BuildContext context) {
...
//                     for (var item in userInfo.read("myLocations")) {
//                       if (nameOfLoc == item["nameoflocation"]) {
//                         setState(() {
//                           constantValues.toRemove.remove(nameOfLoc);
//                           userInfo.read("myLocations").remove(item);
//                         });
//                       }
//                     }
//                     Navigator.of(context).pop();
...
//       if (response.data["success"]) {
//         setState(() {
//           userInfo.write("myLocations", response.data["data"]);
//         });
//       }
//     } on DioError catch (error) {
