                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () async {
                      await Clipboard.setData(ClipboardData(
                              text:
                                  "${userInfo.read("activeOrders")[0]["orderid"]}"))
                          .then((_) {
  ...
  Widget timeline(BuildContext context, var order) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text("Order Timeline (WAT)", style: fontStyle1),
          Padding(
            padding: EdgeInsets.symmetric(horizontal: size.width * 0.05),
            child: Column(
              children: [
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  subtitle:
                      Text("Estimated Delivery Duration", style: fontStyle2),
                ),
                          ...
                          onClicked: () {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (BuildContext context) => Dispatcher(
                                    dispatcher: userInfo.read("dispatcherData"),
                                    dispatcherRatings: userInfo
                                            .read("dispatcherData")["ratings"]
                                        as List<dynamic>)));
                          },
                        ),
                        title: Text(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Padding(
                          ...
                          child: Card(
                            ...
                            child: ListTile(
                              leading: ProfilePicture(
                                image: order["items"][index]["coverimage"]
                                    ["url"],
                                radius: 20,
                                onClicked: () {},
                              ),
                              title: Text(order["items"][index]["packagename"]),
                              subtitle:
                                  Text("Qty: ${order["items"][index]['qty']}"),
                              trailing: Text(
