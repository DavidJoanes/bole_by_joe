// ignore_for_file: must_be_immutable, prefer_typing_uninitialized_variables, use_build_context_synchronously, unused_field, avoid_web_libraries_in_flutter
...
class _PackageInfoState extends State<PackageInfo> {
  ...
  _addRating() async {
    ...
    if (rating_ != null) {
      ...
      return ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text("Rating is required!")));
    }
  }
